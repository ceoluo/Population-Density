...
sys.path.append('../')
from mtcnn.prepare_data.utils import *
...
def py_nms(boxes, threshold, method='Min'):
    if boxes.size == 0:
        return np.empty((0, 3))
    x1 = boxes[:, 0]
    y1 = boxes[:, 1]
...
class MtcnnDetector:
    ...
    def detect_onet(self, im, dets):
        ...
        boxes = boxes[py_nms(boxes, 0.7)]
        keep = py_nms(boxes_c, 0.7)
    ...
    def generate_bbox(self, cls_map, reg, scale, threshold):
        ...
        # 将置信度高的留下，返回condition中元素为true对应的索引
